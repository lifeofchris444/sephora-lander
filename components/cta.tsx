  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-12 pb-16 sm:pt-16 sm:pb-20 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#000000] rounded-3xl p-8 sm:p-12 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Join thousands of beauty lovers who have already claimed their $750 Sephora gift card. Your savings are just a few clicks away.
            </p>
