...
import { Palette, Droplets, Sparkles, Brush } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Shop foundation, lip products, palettes, and trending beauty must-haves.",
  },
  {
    icon: Droplets,
    secondaryIcon: Sparkles,
    ...
    description:
      "Browse cleansers, serums, moisturizers, and top skincare brands.",
  },
  {
    icon: Sparkles,
    ...
    description:
      "Explore perfumes, body care, and premium beauty picks.",
  },
  {
    icon: Brush,
    ...
    description:
      "Upgrade your routine with brushes, beauty tools, and everyday essentials.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-foreground mt-3 max-w-2xl mx-auto text-balance">
            What You Can Do With Your $750 Sephora Gift Card
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            ...
            >
              {/* Icon composition area - consistent soft black tint for all cards */}
              <div className="relative h-48 bg-[#000000]/[0.04] overflow-hidden">
                ...
                {/* Decorative circles - subtle black tint */}
              ...
              <div className="relative p-6 sm:p-8 pt-8 sm:pt-10">
                <div className="w-14 h-14 bg-[#000000]/10 border border-[#000000]/20 rounded-2xl flex items-center justify-center mb-6 -mt-14 relative z-10 shadow-lg group-hover:bg-[#000000] group-hover:border-[#000000] transition-all duration-300">
