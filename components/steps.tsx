...
const steps = [
  ...
  {
    icon: ClipboardCheck,
    title: "Complete the Sephora survey",
  ...
  {
    icon: Trophy,
    title: "Receive your $750 Sephora gift card",
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4">
            {steps.map((step, index) => (
              <div
                key={index}
                className={`group bg-card border border-border/60 rounded-2xl p-5 hover:border-[#000000]/30 transition-all duration-300 hover:shadow-lg hover:shadow-black/5 hover:-translate-y-1 touch-card ${
